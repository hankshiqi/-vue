    ...
    <el-card style="width: 50%">
      <el-form :model="user" label-width="100px" style="padding-right: 50px">
        ...
        <el-form-item label="介绍" prop="info">
          <el-input type="textarea" v-model="user.info" placeholder="介绍"></el-input>
        </el-form-item>
        ...
        <el-form-item label="身份证号码" prop="cardNo">
          <el-input v-model="user.cardNo" placeholder="身份证号码"></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    update() {
      // 保存当前的用户信息到数据库
      this.$request.put('/volunteer/update', this.user).then(res => {
        if (res.code === '200') {
          // 成功更新
    ...
    handleCardImgSuccess(response) {
      this.user.cardImg = response.data
    }
  }
}
</script>
